...
<H1>Marks</H1>
	...
	$sql=oci_parse($conn,"Select * from marks where ssn='$username' ");
			oci_execute($sql);
			echo "<table border=1>";
			echo "<tr><th>Username</th><th>Course</th><th>Assignments</th><th>Quizes</th><th>Mid_exam</th><th>Final_exam</th></tr>";
