...
<ul id="css3menu2" class="topmenu">
	<li class="topfirst"><a href="index1.php" style="width:84px;height:19px;line-height:19px;">Inst Info</a></li>
...
<form align = "center" method="post" action="sub_atten.php">
			<br><br><br><br><br><br>
			<label id="lcol"> Student Ssn </label>
			<input type="text" name = "username"> </input>
			<br>
			<label id="lcol"> Course </label>
			<input type ="text" name = "course"> </input>
			<br>
			<label id="lcol"> Date </label>
			<input type ="text" name = "datee"> </input>
			<br>
			<label id="lcol"> Present </label>
			<input type ="text" name = "present"> </input>
			<br>
